...
namespace RandomChance
{
    public class IncidentWorker_FlickeringLights : IncidentWorker_MakeGameCondition
    {
        protected override bool CanFireNowSub(IncidentParms parms)
        {
            ...
            return !map.GetComponent<MapComponent_CollectThings>().AvailableLightSources
                .NullOrEmpty();
        }
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            MapComponent_FlickerLightSources mapComp = map
                .GetComponent<MapComponent_FlickerLightSources>();
